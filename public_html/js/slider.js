// import './simple-adaptive-slider';
// SimpleAdaptiveSlider не найден при импорте
...
document.addEventListener('DOMContentLoaded', function() {
    let select_company_slider = 0;
    let about_company_slider = new SimpleAdaptiveSlider('.about_company_slider', {
        loop: true,
        autoplay: false,
        interval: 5000,
        swipe: true,
    });
    $('#count_slider_about_company').html((about_company_slider._currentIndex+1)+'/'+about_company_slider._$itemList.length);
    document.querySelector('.about_company_slider__arrow__left').onclick = function () {
        about_company_slider.prev();
    }
    document.querySelector('.about_company_slider__arrow__right').onclick = function () {
        about_company_slider.next();
    }
    // Прослушка на смену слайда
    var $target = jQuery(".about_company_slider .slider__item");
    var observer = new MutationObserver(function() {
        $('#count_slider_about_company').html((about_company_slider._currentIndex+1)+'/'+about_company_slider._$itemList.length);
        select_company_slider = about_company_slider._currentIndex;
    });
    observer.observe($target[0],  {
        attributes: true
    });
    // Конец прослушки на смену слайда
}, false);


//header_stock
document.addEventListener('DOMContentLoaded', function() {
    let slider_stock = new SimpleAdaptiveSlider('.slider_stock', {
        loop: true,
        autoplay: false,
        interval: 5000,
        swipe: true,
    });
    document.querySelector('.header_slider__arrow__left').onclick = function () {
        slider_stock.prev();
    }
    document.querySelector('.header_slider__arrow__right').onclick = function () {
        slider_stock.next();
    }
    // Прослушка на смену слайда
    var $target = jQuery(".slider_stock .slider__item");
    var observer = new MutationObserver(function() {
        // событие смены слайда
        $('#slider_stock_title').html($('.slider_stock .slider__item_active').attr('data-title'));
        $('#slider_stock_description_1').html($('.slider_stock .slider__item_active').attr('data-description'));
        $('#slider_stock_description_2').html($('.slider_stock .slider__item_active').attr('data-description'));
        $('#slider_stock_url').attr("href", $('.slider_stock .slider__item_active').attr('data-url'));
    });
    observer.observe($target[0],  {
        attributes: true
    });
...
//what_are_we
document.addEventListener('DOMContentLoaded', function() {
    let select_where_are_we_slider = 0;
    let where_are_we_slider = new SimpleAdaptiveSlider('.where_are_we_slider', {
        loop: true,
        autoplay: false,
        interval: 5000,
        swipe: true,
    });
    $('#count_slider_where_are_we').html((where_are_we_slider._currentIndex+1)+'/'+where_are_we_slider._$itemList.length);
    document.querySelector('.where_are_we_slider__arrow__left').onclick = function () {
        where_are_we_slider.prev();
    }
    document.querySelector('.where_are_we_slider__arrow__right').onclick = function () {
        where_are_we_slider.next();
    }
    // Прослушка на смену слайда
    var $target = jQuery(".where_are_we_slider .slider__item");
    var observer = new MutationObserver(function() {
        $('#count_slider_where_are_we').html((where_are_we_slider._currentIndex+1)+'/'+where_are_we_slider._$itemList.length);
        select_where_are_we_slider = where_are_we_slider._currentIndex;
    });
    observer.observe($target[0],  {
        attributes: true
    });
    ...
    // Второй слайдер
    let select_where_are_we_slider_two = 0;
    let where_are_we_slider_two = new SimpleAdaptiveSlider('.where_are_we_slider_two', {
        loop: true,
        autoplay: false,
        interval: 5000,
        swipe: true,
    });
    $('#count_slider_where_are_we_two').html((where_are_we_slider_two._currentIndex+1)+'/'+where_are_we_slider_two._$itemList.length);
    document.querySelector('.where_are_we_slider__arrow__left_two').onclick = function () {
        where_are_we_slider_two.prev();
    }
    document.querySelector('.where_are_we_slider__arrow__right_two').onclick = function () {
        where_are_we_slider_two.next();
    }
    // Прослушка на смену слайда
    var $target = jQuery(".where_are_we_slider_two .slider__item");
    var observer = new MutationObserver(function() {
        $('#count_slider_where_are_we_two').html((where_are_we_slider_two._currentIndex+1)+'/'+where_are_we_slider_two._$itemList.length);
        select_where_are_we_slider_two = where_are_we_slider_two._currentIndex;
    });
    observer.observe($target[0],  {
        attributes: true
    });
